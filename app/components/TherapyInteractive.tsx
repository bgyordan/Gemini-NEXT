...
const THERAPIES: TherapyItem[] = [
  ...
  },
  {
    ...
    fullDetails:
      'Училищният двор е обезопасено и озеленено пространство, което кани децата към движение, игра и досег с природата. Тук се провеждат занимания на открито, спортни игри и градинарство, които подкрепят физическото развитие и създават усещане за свобода и спокойствие.',
    equipment: ['Обезопасена площадка', 'Зелена градина', 'Кътове за игра', 'Пространство за спорт'],
    skills: ['Физическа активност', 'Игра на открито', 'Досег с природата', 'Социално общуване'],
    image: '/nachalna/dvor-1.jpg',
    icon: 'sparkles',
  },
];
