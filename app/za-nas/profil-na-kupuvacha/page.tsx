        ...
        <div className="wrap narrow">
          ...
          <div className="pk-find prose-block">
            ...
            <ul>
              ...
              <li>възложени договори и документи по процедурите;</li>
            ...
            <p>
              За да откриете процедура на ЦСОП – Варна, използвайте наименованието на институцията като
              възложител при търсене в системата или отворете директно профила чрез бутона по-горе.
            </p>
          </div>
        </div>
      </div>
